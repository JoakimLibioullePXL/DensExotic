...
export class EventService {
  private events: Event[] = [
    ...
    new Event(
      5,
      'Dens Meet Zolder Circuit',
      'Drie unieke ervaringen op één dag: showcars & showbikes, spectaculair driften en zelf rijden op het circuit – mis het niet',
      ...
      0,
      'NVT',
      '/assets/exotic-events/zolder-event/zolder-event-1.jpg',
      'https://www.instagram.com/densexotics/?hl=en',
      [
        new Activity('test', 'test', '/assets/exotic-events/zolder-event/zolder-event-2.jpg'),
        new Activity('test', 'test', '/assets/exotic-events/zolder-event/zolder-event-3.jpg'),
        new Activity('test', 'test', '/assets/exotic-events/zolder-event/zolder-event-4.jpg'),
      ]
    )
  ];
